...
public class MainIncrementarPrecioProducto {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		/**********************************************************************************/
		long idProducto2 = 77; // Salsa verde - 13€ el precio por unidad
		System.out.println(abd.incrementarPrecioProducto(idProducto2, 0.25));
		// Imprime 1 y ha incrementado la Salsa verde de 13€ a 16,25€ (un 25%)
		/***********************************************************************************/
		long idProducto3 = 80;
		System.out.println(abd.incrementarPrecioProducto(idProducto3, 0.1));	
